...
export default class Slider extends PureComponent {
  ...
  render() {
    ...
    const isCustomThumLabel = typeof customThumbLabel !== 'undefined' && customThumbLabel().props.children
    ...
    return (
      ...
      >
        ...
        <Animated.View
          ...
          renderToHardwareTextureAndroid
          style={[
            isCustomThumLabel ? customThumbLabelStyle : { backgroundColor: thumbTintColor },
            !isCustomThumLabel ? mainStyles.thumb : null,
            !isCustomThumLabel ? thumbStyle : null,
            {
        ...
        >
          {isCustomThumLabel ? customThumbLabel() : this._renderThumbImage()}
        </Animated.View>
        <View
          renderToHardwareTextureAndroid
